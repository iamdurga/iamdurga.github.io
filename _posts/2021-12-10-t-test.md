...
I want to hypothesize that the mean 'mpg' is very close to 20. To determine whether I can make this claim or not, I will use a one-sample t-test. We will use a significance level of 0.05, which represents the percentage of error that we can tolerate.
